package som_processing.processors;
...
//	    Map<Integer, String> systemcallMap = new HashMap<Integer, String>();
		...
		// printing out vectors. frequecy, time, appearance
				...
				try{
					...
					file0 = new FileWriter(Constants.BASE_FILE_LOCATION + "flume_freqvector.csv");
					out0 = new BufferedWriter(file0);
						
					file4 = new FileWriter(Constants.BASE_FILE_LOCATION
					+ "flume_freqvector_test.csv");
					out4 = new BufferedWriter(file4);
						
					file1 = new FileWriter(Constants.BASE_FILE_LOCATION + "flume_timevector.csv");
					out1 = new BufferedWriter(file1);
					
					file5 = new FileWriter(Constants.BASE_FILE_LOCATION
					+ "flume_timevector_test.csv");
					out5 = new BufferedWriter(file5);
					
					file2 = new FileWriter(Constants.BASE_FILE_LOCATION + "flume_appvector.csv");
					out2 = new BufferedWriter(file2);
					
					file6 = new FileWriter(Constants.BASE_FILE_LOCATION
